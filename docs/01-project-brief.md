# Project Brief — Soul Hub

## 1. One-Line Description

Soul Hub places relatable, curiosity-driven messages on everyday physical surfaces and connects them, via QR code, to short video clips and a warm invitation to Phaneroo.
...
**Primary goal:** Turn curious strangers into people who take a next step toward Phaneroo, while respecting their choice not to.

**Success metrics (pilot):**
- Scan rate per surface (target: 1–5%, measured against surface placement)
- Clip completion rate (target: >50%)
- Next-step rate (form submission or equivalent action)
- Handoff success rate (form submissions reaching Follow Up)
- Follow Up response time (within promised window)

**Non-goals:** Mass conversion, viral reach, or replacing existing evangelism methods.
...
- Private, receptive moments (hotel rooms, late night)
- Time-bound moments (conference build-up, service invitations)

Each moment calls for a different hook style and a different next step.
...
- **One surface** (hotel rooms or cups — not poles)
- **One hook style** per surface, tested against 3–4 variants
- **A small set of clips** (3–4 topics)
- **One season ad** at launch
- **One handoff path** into Follow Up
- **Scan tracking** per surface code

## 8. Out of Scope (Pilot)

- Public poles (low trust, no dwell time, legal risk)
- Multi-language support
- Full automation of Follow Up integration
- Deep API integration with Phaneroo's existing apps
- Paid advertising or distribution
- Public launch under `phaneroo.org` (temporary domain first)

## 9. Stakeholders and Owners

| Role | Responsibility |
|:---|:---|
| Project owner | Overall direction, decisions |
| Content lead | Surface lines, clip scripts, season ad copy |
| Technical lead | Redirect service, Hub, tracking |
| Follow Up lead | Handoff intake, response flow, capacity |
| Design lead | Surface layout, QR placement, Hub UI |

Named individuals to be assigned.
...
- Which surface launches first — hotel rooms or cups?
- Who writes the surface lines and clip scripts?
- What is the season ad calendar, and who owns it?
- What is the Follow Up team's response-time promise?
- Which topic tags (3–4) become the form dropdown?
- What is the temporary domain name for the pilot?
- How is scan data reviewed, and how often?

## 12. Definition of Done (Pilot)

The pilot is complete when:
- At least one surface has been printed and placed
- Scan events are being logged per surface code
- The Hub serves matched clips for each surface code
- The season ad rotates without reshooting clips
- Form submissions reach Follow Up
- Scan rate, clip completion, and next-step rate have been measured
- A decision has been made on whether to expand, adjust, or stop