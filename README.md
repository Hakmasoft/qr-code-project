...
- Surfaces carry no explicitly religious vocabulary. The clip does the spiritual work.
- Surface lines are human, relatable, specific, and unresolved. One to two lines, readable in two seconds.
- The clip must honor the surface's promise within the first 15 seconds.
